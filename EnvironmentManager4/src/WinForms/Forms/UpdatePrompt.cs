    ...
    public partial class UpdatePrompt : Form
    {
        ...
        private void Update_Load(object sender, EventArgs e)
        {
            ...
            tbText.Text = String.Format("{0}\r\n\r\nCurrent Version: {1}\r\nNew Version: {2}",
                text,
                AppVersionUtilities.GetAppVersion(),
                AppVersionUtilities.GetLatestVersion());
            return;
        }

        private void btnYes_Click(object sender, EventArgs e)
        {
            ProcessStartInfo info = new ProcessStartInfo(DirectoryUtilities.GetFile("GetLatestEnvironmentManager.bat"));
            Process.Start(info);
            this.Close();
            return;
        }
