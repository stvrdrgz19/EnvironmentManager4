...
namespace EnvironmentManager4.Build_Management
{
    public partial class InstallPropertiesMonitor : Form
    {
        ...
        private static void LoadProductList(ComboBox cbProducts)
        {
            ...
            foreach (string product in ProductsOld.ListOfProducts())
            {
                cbProducts.Items.Add(product);
            }
            cbProducts.SelectedIndex = cbProducts.FindStringExact(ProductsOld.SalesPad);
        }
        ...
        private void cbProducts_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (product != ProductsOld.SalesPad && product != ProductsOld.ShipCenter)
        ...
        private void lvInstalledBuilds_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                foreach (DLLFileModel dllModel in CustomDLLs)
                    ...
                    if (ip.Product == ProductsOld.DataCollection)
                    {
                ...
                UtilitiesOld.ResizeUpdateableListViewColumnWidthForScrollBar(lvInstallProperties, 9, 1, 329);
            }
            catch
            {
