...
{
    public partial class BuildPropertiesMonitor : Form
    {
        private int sortBuildColumn = -1;
        private int sortPropertiesColumn = -1;

        public BuildPropertiesMonitor()
        {
            InitializeComponent();
        }
        ...
        private void BuildPropertiesMonitor_Load(object sender, EventArgs e)
        {
        ...
        private void lvInstalledBuilds_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Utils.ResizeUpdateableListViewColumnWidthForScrollBar(lvInstallProperties, 9, 1, 329);
            }
            catch
            {
